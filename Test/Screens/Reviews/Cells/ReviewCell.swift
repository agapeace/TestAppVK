...
private final class ReviewCellLayout {
    ...
    fileprivate static let ratingSize = CGSize(width: 75.0, height: 16.0)
    fileprivate static let avatarCornerRadius = 18.0
    fileprivate static let photoCornerRadius = 10.0
    ...
    func height(config: Config, maxWidth: CGFloat) -> CGFloat {
        ...
        avatarImageViewFrame = CGRect(origin: CGPoint(x: avatarX, y: avatarY), size: avatarSize)
        ...
        fullNameLabelFrame = CGRect(
            ...
            size: config.fullNameText.boundingRect(width: width).size
        )
        
        maxY = fullNameLabelFrame.maxY + usernameToRatingSpacing
        
        ratingImageViewFrame = CGRect(
            origin: CGPoint(x: contentX, y: maxY), size: ReviewCellLayout.ratingSize)
